...
public class GameManager : MonoBehaviour
{
    ...
    private Rigidbody2D player1Rigitbody;

    // Pemain 2
    public PlayerControl player2;
    private Rigidbody2D player2Rigitbody;
    ...
    private void Start()
    {
        player1Rigitbody = player1.GetComponent<Rigidbody2D>();
        player2Rigitbody = player2.GetComponent<Rigidbody2D>();
    ...
    void OnGUI()
    {
        ...
        {
            // Ketika tombol restar ditekan, reset skor kedua pemain
            player1.ResetScore();
            player2.ResetScore();
